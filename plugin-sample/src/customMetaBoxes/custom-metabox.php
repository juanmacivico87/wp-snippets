...
class JMC87_CustomMetabox
{
    ...
    public function jmc87_add_sample_metabox()
    {
        add_meta_box(
            $this->metabox_id,
            __( 'Sample Meta Box Title', PLG_TEXTDOMAIN ),
    ...
    public function jmc87_render_sample_metabox( $post )
    {
        ...
        <label for="<?php echo $this->metabox_id ?>"><?php _e( 'Description for this metabox', PLG_TEXTDOMAIN ) ?></label>
        <select name="<?php echo $this->metabox_id ?>" id="<?php echo $this->metabox_id ?>">
            <option value="-1"><?php _e( 'Select an option', PLG_TEXTDOMAIN ) ?></option>
            <option value="1" <?php selected( $value, '1' ); ?>><?php _e( 'Option 1', PLG_TEXTDOMAIN ) ?></option>
            <option value="2" <?php selected( $value, '2' ); ?>><?php _e( 'Option 2', PLG_TEXTDOMAIN ) ?></option>
        </select>
